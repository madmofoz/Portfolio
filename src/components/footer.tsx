    ...
    <footer className="w-full py-24 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black overflow-hidden">
      <div className="w-full px-[5vw]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-24">
          ...
          <div className="text-left md:text-right space-y-4">
            ...
            <p className="text-sm font-bold uppercase leading-none">
              ...
              <span className="text-zinc-400 text-[10px]">Optimized for Wide Monitors v2.1.12</span>
            </p>
          </div>
        </div>
        ...
        <div className="relative">
          <h2 className="text-[18vw] font-black leading-[0.7] tracking-tighter uppercase text-zinc-100 dark:text-white/5 select-none pointer-events-none mb-12">
            ZHIFRANTINO
          </h2>
          ...
          <div className="absolute bottom-4 left-0 w-full flex flex-col md:flex-row justify-between items-end gap-4">
            <div className="flex flex-col">
              <span className="text-[10px] font-mono font-black uppercase tracking-[0.5em] text-zinc-500">Muhammad Zhifrantino</span>
            ...
            <div className="hidden lg:flex items-center gap-4 text-[10px] font-mono text-zinc-400 uppercase tracking-widest">
              <span className="text-zinc-500">Status: The Developers Are Doing Calisthenics</span>
